...
VALUES
    ('takhirjon22@mail.ru', 'Takhirzhan', '$2a$12$NVozRfXN.NtAHw6dcZQhk.ebUT3w3ghJkrdcdgOb.beBVMmk.hiY.'),
...
INSERT INTO t_users_permissions (users_id, permissions_id)
VALUES
    (2, 1),
    (3, 1),
    (4, 1),
...
('My favorite hotel. Convenient location close to the old town and the railway station. Incredibly comfortable bed, stunning design, delicious breakfast', '2023-08-07 10:52:33', 1),
('Very clean and classy. Friendly staff, food amazing breakfast too lovely to eat, a picture of color.', '2023-08-07 10:53:06', 1),
('Good service, clean rooms, excellent location', '2023-08-07 11:04:08', 1);
...
INSERT INTO t_hotels(description, name, price, rating, text, city, address) VALUES
            ('All rooms at Captain Cook Hotel offer beautiful views of the Chugach Mountains or the Cook Strait.
             ...
             'The Hotel Captain','600','9,0','This all-suite hotel is located in downtown Anchorage, 7 blocks from the
              Anchorage Museum. It features 4 restaurants, a conference center and 15 shops.','Anchorage','939 West 5th Avenue, Анкоридж, AK 99501'),
            ...
            and Body Works ','Hilton Anchorage Hotel','700','8,0',
            ...
            Arena and 3.9 km from Dena ina Civic Convention Center. Featuring a 24-hour front desk','E Central Hotel Downtown','400','7,8',
